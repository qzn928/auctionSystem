#!/usr/bin/env python
#
# Setup script for PGC-site Project.
#
...
from auctionSystem import get_package_version, is_release, VERSION
...
PACKAGE_NAME = 'AuctionSystem'


# Build the reviewboard package.
setup(name=PACKAGE_NAME,
      version=get_package_version(),
      description="AUction-site Project",
      author="YY Team",
      author_email="18501377614@163.com",
